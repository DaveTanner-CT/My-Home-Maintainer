...
function PDS_getSchemas_() {
  return {
    ...
    Rooms: ['RoomID','ProjectID','RoomName','RoomType','SortOrder','Notes','LengthFeet','LengthInches','WidthFeet','WidthInches','CeilingHeightFeet','CeilingHeightInches','DimensionUnit','CreatedDate','LastUpdatedDate'],
