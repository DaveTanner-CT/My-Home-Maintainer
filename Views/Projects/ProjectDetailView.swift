...
struct ProjectDetailView: View {
    ...
    var body: some View {
        ...
        .toolbar { ToolbarItemGroup(placement: .topBarTrailing) { NavigationLink("Edit") { ProjectFormView(existing: project) }; Menu { Button { showAddItem = true } label: { Label("Idea / Product", systemImage: "lightbulb") }; Button { showAddMeasurement = true } label: { Label("Measurement", systemImage: "ruler") } } label: { Image(systemName: "plus") } } }
