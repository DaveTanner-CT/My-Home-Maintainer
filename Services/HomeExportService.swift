...
struct SystemSnapshot: Codable { let name, type, manufacturer, model, serialNumber, location, notes, website, vendorName: String; let installationDate, warrantyExpiration: Date?; let purchaseCost: Double?; let expectedServiceLifeYears: Int? }
...
enum HomeExportService {
    static func makeArchive(context: ModelContext) throws -> HomeArchive {
        ...
        return HomeArchive(
            ...
            paint: paints.map { .init(roomName: $0.roomName, surface: $0.surface, brand: $0.brand, productLine: $0.productLine, colorName: $0.colorName, colorCode: $0.colorCode, sheen: $0.sheen, store: $0.store, containerSize: $0.containerSize, notes: $0.notes, productLink: $0.productLink, purchaseDate: $0.purchaseDate, quantity: $0.quantity, cost: $0.cost) },
    ...
    private static func ownerDescription(for attachment: HomeAttachment) -> (type: String, name: String) {
        ...
        if let value = attachment.paint { return ("Paint / Finish", "\(value.roomName) - \(value.surface)") }
